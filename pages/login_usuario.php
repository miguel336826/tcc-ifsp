    ...
    <form method="post" id="formLoginUsuario">
        <div class="grid-container d-flex justify-content-center">
            <div class="col-4">
                ...
                <button id="btnLoginUsuario" type="submit" class="form-control btn btn-danger mb-2 mt-5" style="width: 109px; height: 38px;">Entrar</button>
                <br>
                <a href="./login_administrador.php" class="btn btn-link link-primary link-offset-2 link-underline link-underline-opacity-0">Entrar como administrador</a>
            </div> 
        </div>
    </form>
    <script src="../assets/javascripts/scripts_login_usuario.js"></script>
    <script src="../assets/javascripts/valida_login_usuario.js"></script>
</body>
</html>
...
const btnEnviar = document.getElementById("btnAdicionarAdmin");
btnEnviar.classList.add("disabled");

function verEspacos(){
    const nome = document.getElementById("nome_admin").value;
    const sobrenome = document.getElementById("sobrenome_admin").value;
    const nasc = document.getElementById("nascimento_admin").value;
    const email = document.getElementById("email_admin").value;
    const senha = document.getElementById("senha_admin").value;
...
function verificarNome(){
    let textoNome = document.getElementById("nome_admin").value;
    let tmpNome = "";
    ...
    document.getElementById("nome_admin").value = tmpNome;
}
...
function verificarSobrenome(){
    let textoSobrenome = document.getElementById("sobrenome_admin").value;
    ...
    document.getElementById("sobrenome_admin").value = tmpSobrenome;
}
...
function verificarData(){
    let textoData = document.getElementById("nascimento_admin").value;
    let tmpData = "";
    ...
    document.getElementById("nascimento_admin").value = tmpData;
}
...
function validarEmail(){
    let textoEmail = document.getElementById("email_admin").value;
...
function validarSenha(){
    let textoSenha = document.getElementById("senha_admin").value;
...
document.getElementById("nome_admin").addEventListener("input",verificarNome)
document.getElementById("nome_admin").addEventListener("blur",validarNome)
document.getElementById("sobrenome_admin").addEventListener("input",verificarSobrenome)
document.getElementById("sobrenome_admin").addEventListener("blur",validarSobrenome)
document.getElementById("nascimento_admin").addEventListener("input", validarData)
document.getElementById("nascimento_admin").addEventListener("input", verificarData)
document.getElementById("nascimento_admin").addEventListener("blur", validarData)
document.getElementById("email_admin").addEventListener("input", validarEmail)
document.getElementById("email_admin").addEventListener("blur", validarEmail)
document.getElementById("senha_admin").addEventListener("input", validarSenha)
document.getElementById("senha_admin").addEventListener("blur", validarSenha)
